        ...
        Scaffold(
          appBar: AppBar(
            title: Align(
                ...
                child: Text("ادخال طلب", style: TextStyle(color: Colors.black))),
          ...
          body: Container(
            ...
            child: ListView(children: [
              ...
              Container(height: 20,),
            Center(child: Text("اهلا بك " ,style: TextStyle(
              fontSize: 25,
            ...
            ElevatedButton(
              ...
              child: Text('ارسال',style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold,color: Colors.white)),)
          ],),
