                      ...
                      child: Card(
                        ...
                        child: Column(children: [
                          ...
                          Text(
                            ...
                            style:
                            TextStyle(fontSize: 20, fontWeight: FontWeight.w600,color: Colors.orangeAccent),
                          ),


                          Text('  عيار ${ProductList[i].caliber.toString()}', style:
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Text(
                                  '  ${ProductList[i].gram.toString()}    ', style:
                              TextStyle(fontSize: 17, fontWeight: FontWeight.w600,color: Colors.black)),
                              Text("جرام", style:
                              TextStyle(fontSize: 17, fontWeight: FontWeight.w600,color: Colors.orangeAccent)),
                            ],
                          ),
